...
If the source table supports a notion of missing data in a column, it should return a `DataValueVector` from the [DataValues.jl](https://github.com/davidanthoff/DataValues.jl) package for such columns.
