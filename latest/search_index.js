...

{
    ...
    "category": "section",
    "text": "If you pass a filename with the extension *.parquet to the load function, FileIO.jl will use the ParquetFiles.jl package to load that file. The following example demonstrates how you can load a Feather file:using Dataverse\n\n# Load a local file\ndf = load(\"mydata.parquet\") |> DataFrameThere are no options you can specify when loading a Parquet file."
},
...
{
    "location": "iterabletables.html#",
    "page": "Advanced - Iterable Tables",
    "title": "Advanced - Iterable Tables",
    "category": "page",
    "text": ""
},

{
    "location": "iterabletables.html#Advanced-Iterable-Tables-1",
    "page": "Advanced - Iterable Tables",
    "title": "Advanced - Iterable Tables",
    "category": "section",
    "text": "This chapter describes the internals of the iterable tables interface. Most data science users do not need to read this chapter, it mostly targets developers that want to integrate their own packages with the ecosystem of packages described in this book."
},

{
    "location": "iterabletables.html#Specification-1",
    "page": "Advanced - Iterable Tables",
    "title": "Specification",
    "category": "section",
...
{
    "location": "iterabletables.html#Signaling-and-detection-of-iterable-tables-1",
    "page": "Advanced - Iterable Tables",
...
{
    "location": "iterabletables.html#Iteration-conventions-1",
    "page": "Advanced - Iterable Tables",
...
{
    "location": "iterabletables.html#Integration-Guide-1",
    "page": "Advanced - Iterable Tables",
...
{
    "location": "iterabletables.html#Consuming-iterable-tables-1",
    "page": "Advanced - Iterable Tables",
...
{
    "location": "iterabletables.html#Creating-an-iterable-table-source-1",
    "page": "Advanced - Iterable Tables",
...
{
    "location": "iterabletables.html#Directly-implementing-the-julia-base-iteration-trait-1",
    "page": "Advanced - Iterable Tables",
...
{
    "location": "iterabletables.html#Creating-a-custom-iteration-type-1",
    "page": "Advanced - Iterable Tables",
